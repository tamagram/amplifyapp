                ...
                <Card className="my-3">
                  <Stack gap={2} className="m-3">
                    ...
                    >
                      <Form.Select
                        aria-label="Floating label select example"
                        value={editingTarget.largeCategory}
                        onChange={(e) => {
                          setEditingTarget({
                            ...editingTarget,
                    ...
                    >
                      <Form.Select
                        aria-label="Floating label select example"
                        value={editingTarget.mediumCategory}
                        onChange={(e) => {
                          // setMediumCategory(e.target.value);
                          setEditingTarget({
                            ...editingTarget,
                            mediumCategory: e.target.value,
                          });
                        }}
                      >
                        <option>選択</option>
                  ...
                  <Button
                    ...
                    onClick={() => {
                      setEditingTarget({
                        ...editingTarget,
                        sku:
                          editingTarget.brandCode +
                          editingTarget.year +
                          editingTarget.season +
                          editingTarget.largeCategory +
                          editingTarget.mediumCategory +
                          editingTarget.smallCategory +
                          "-" +
                          editingTarget.color,
                      });

                      if (window.confirm("更新しますか？")) {
                        console.dir(editingTarget);
                        updateProduct();
                      }
                    }}
                  >
